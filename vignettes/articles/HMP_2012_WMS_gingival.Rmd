...
Unique subjects per body subsite:
...
Set normalization, weights, and DA methods parameters:
...
esThr[grep("lefse.CLR", names(esThr))] <- round(median(
    DA_output$lefse.CLR$statInfo$abs_score
), 2)
