---
title: "Subgingival vs supgragingival plaque (V35 - OTU)"
...
DT::datatable(enrichmentSummary)
```
What three methods had non-significant aerobic supragingival results?
```{r}
enrichmentSummary |> filter(direction == "Supragingival" & annotation=="aerobic" & pvalue > 0.05)
```
...
ggsave(
    filename = "Figure1.png", plot = pp, dpi = 300,
    height = 9, width = 10, 
)
```
