...
```{r}
tse <- getDataset("Beghini_2019_16S_smoking", dryrun = FALSE)[[1]]

grp <- "grp"

## subgingival will be used as 'control'
conditions <- c(condB = "never_smoker", condA = "cigarette")
```
...
positives <- createPositives(
    object = DA_results, 
    priorKnowledge = priorInfo, enrichmentCol = "biosis", namesCol = "newNames",
    slot = "pValMat", colName = "rawP", type = "pvalue",
    direction = direction,
    threshold_pvalue = 0.05,
    threshold_logfc = 0,
    ...
    alternative = "greater",
    verbose = FALSE,
    TP = list(c("DOWN Abundant", "Aerobic"), c("UP Abundant", "Anerobic")),
    FP = list(c("DOWN Abundant", "Anaerobic"), c("UP Abundant", "Aaerobic"))
)
```
